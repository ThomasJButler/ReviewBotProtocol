...
- Pull requests opened by a bot (dependabot, renovate) are skipped unless `REVIEW_BOT_PULL_REQUESTS=true`; the delivery is recorded as `skipped_bot` and the Status page shows both this and the draft setting.
